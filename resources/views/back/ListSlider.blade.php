                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="btn-popup pull-right">
                                    <a class="btn btn-primary" href="slider/create">Ajouter slider</a>
                                </div>
                                ...
                                @foreach($sliders as $slider)
                                     ...
                                     <td>{{$slider->id}}</td>
                                    <td>{{$slider->soutitre}}</td>
                                    <td>{{$slider->titre}}</td>
                                    <td><img src="{{ URL::to('/') }}/images/{{ $slider->image }}" class="img-thumbnail" width="75" /></td>
                                    <td>
                                 <a href="{{ route('slider.edit', $slider->id) }}" id="edit-user"  class="btn btn-warning" value="Edit">Modifier</a>

                        ...
                        <div class="card tab2-card">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs tab-coupon" id="myTab" role="tablist">
                                    <li class="nav-item"><a class="nav-link active show" id="account-tab" data-toggle="tab" href="#account" role="tab" aria-controls="account" aria-selected="true" data-original-title="" title="">Ajouter Image</a></li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active show" id="account" role="tabpanel" aria-labelledby="account-tab">
                                        <form class="needs-validation user-add" method="POST" action="{{ route('galerie.update',$galerie->id) }}" enctype="multipart/form-data">
                            ...
                            <fieldset>
                                            ...
                                            <div class="form-group row">
                                                    ...
                                                    <select class="form-control digits col-xl-8 col-sm-7" id="exampleFormControlSelect1" name="type" value="{{ $galerie->type }}">

                                                        <option value="">Quelques produits</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <img src="{{ URL::to('/') }}/images/{{ $galerie->image }}" class="img-thumbnail" width="100" />
                                                 <input type="hidden" name="hidden_image" value="{{ $galerie->image }}" />
                                            </div>   

                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="btn-popup pull-right">
                                    <a class="btn btn-primary" href="galerie/create">Ajouter image</a>
                                </div>
                                ...
                                @foreach($galeries as $galerie)
                                     ...
                                     <td><img src="{{ URL::to('/') }}/images/{{ $galerie->image }}" class="img-thumbnail" width="75" /></td>
                                    <td>                          
                     
                                 <a href="{{ route('galerie.edit', $galerie->id) }}" id="edit-user"  class="btn btn-warning" value="Edit">Modifier</a>
                                 <form method="POST" action="{{ route('galerie.destroy', $galerie->id) }}">   
                                         @csrf
                                  @method('DELETE')

                        ...
                        <div class="card tab2-card">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs tab-coupon" id="myTab" role="tablist">
                                    <li class="nav-item"><a class="nav-link active show" id="account-tab" data-toggle="tab" href="#account" role="tab" aria-controls="account" aria-selected="true" data-original-title="" title="">Ajouter Slider</a></li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active show" id="account" role="tabpanel" aria-labelledby="account-tab">
                                        <form class="needs-validation user-add" method="POST" action="{{ route('slider.store') }}" enctype="multipart/form-data" >
                            ...
                            <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input class="form-control col-xl-8 col-md-7" id="soutitre" name="soutitre" type="text" required="">
                                            </div>
                                         
                                            <div class="form-group row">
                                                <label for="validationCustom2" class="col-xl-3 col-md-4"><span>*</span> Titre</label>
                                                <input class="form-control col-xl-8 col-md-7" id="titre" name="titre" type="text" required="">
                                            </div>
                                            <div class="form-group row">
                                                <label for="validationCustom3" class="col-xl-3 col-md-4"><span>*</span>Image (Taille:1920px*686px)</label>

                        ...
                        <div class="card tab2-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active show" id="account" role="tabpanel" aria-labelledby="account-tab">
                                        <form class="needs-validation user-add" method="POST" action="{{ route('galerie.store') }}" enctype="multipart/form-data">
                            ...
                            <fieldset>
                                            ...
                                            <div class="form-group row">
                                                    ...
                                                    <select class="form-control digits col-xl-8 col-sm-7" id="type" name="type">

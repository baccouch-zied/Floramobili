...
<body>
    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section"><img src="{{asset('images/about/about%20us.jpg')}}"
                        ...
                        <div>
                            <div class="media">
                                <div class="text-center">
                                    <img src="{{asset('images/avtar.jpg')}}" alt="#">
                                    <h5>Mark Jecno</h5>
                                    <h6>Designer</h6>
                                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 p-0">
                    <h2 class="title-borderless"># NOTRE LOCAL</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>Offre possible</h4>
                            <p>Des promotion tout au long de l'année</p>
                        </div>
                    </div>
                </div>
            </div>
